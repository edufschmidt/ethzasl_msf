 ...
 */
#ifndef ALTITUDE_MEASUREMENT_HPP_
#define ALTITUDE_MEASUREMENT_HPP_

#include <msf_core/msf_measurement.h>
#include <msf_core/msf_core.h>

namespace altitude_measurement {
enum {
  nMeasurements = 1
};
/**
...
typedef msf_core::MSF_Measurement<geometry_msgs::PointStamped,
    Eigen::Matrix<double, nMeasurements, nMeasurements>, msf_updates::EKFState> AltitudeMeasurementBase;
struct AltitudeMeasurement : public AltitudeMeasurementBase {
 private:
  typedef AltitudeMeasurementBase Measurement_t;
 ...
 public:
  ...
  virtual ~AltitudeMeasurement() {}
  AltitudeMeasurement(double n_zp, bool isabsoluteMeasurement, int sensorID,
                      bool enable_mah_outlier_rejection, double mah_threshold)
      : AltitudeMeasurementBase(isabsoluteMeasurement, sensorID,
                                enable_mah_outlier_rejection, mah_threshold),
        n_zp_(n_zp) {}
  virtual std::string Type() { return "altitude"; }
  /**
