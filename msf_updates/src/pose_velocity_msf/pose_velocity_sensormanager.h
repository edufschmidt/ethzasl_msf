 ...
 */
#ifndef POSE_VELOCITY_MEASUREMENTMANAGER_H
#define POSE_VELOCITY_MEASUREMENTMANAGER_H
...
#include <msf_updates/PoseVelocitySensorConfig.h>
#include <msf_updates/SinglePoseSensorConfig.h>

namespace msf_pose_velocity_sensor {

typedef msf_updates::PoseVelocitySensorConfig Config_T;
typedef dynamic_reconfigure::Server<Config_T> ReconfigureServer;
typedef shared_ptr<ReconfigureServer> ReconfigureServerPtr;

class PoseVelocitySensorManager : public msf_core::MSF_SensorManagerROS<
        msf_updates::EKFState> {
    typedef msf_pose_sensor::PoseSensorHandler<
    msf_updates::pose_measurement::PoseMeasurement<>, PoseVelocitySensorManager> PoseSensorHandler_T;
    friend class msf_pose_sensor::PoseSensorHandler<
            msf_updates::pose_measurement::PoseMeasurement<>, PoseVelocitySensorManager>;
public:
    typedef msf_updates::EKFState EKFState_T;
    typedef EKFState_T::StateSequence_T StateSequence_T;
    typedef EKFState_T::StateDefinition_T StateDefinition_T;

    PoseVelocitySensorManager(
        ...
        ReconfigureServer::CallbackType f = boost::bind(
                    &PoseVelocitySensorManager::Config, this, _1, _2);
        reconf_server_->setCallback(f);
    }

    virtual ~PoseVelocitySensorManager() {
    }
...
#endif  // POSE_VELOCITY_MEASUREMENTMANAGER_H
