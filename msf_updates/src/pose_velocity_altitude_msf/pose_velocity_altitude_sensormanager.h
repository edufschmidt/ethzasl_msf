...
namespace msf_pose_velocity_altitude_sensor {

typedef msf_updates::PoseVelocityAltitudeSensorConfig Config_T;
typedef dynamic_reconfigure::Server<Config_T> ReconfigureServer;
typedef shared_ptr<ReconfigureServer> ReconfigureServerPtr;

class PoseVelocityAltitudeSensorManager : public msf_core::MSF_SensorManagerROS<
        msf_updates::EKFState> {
    typedef msf_pose_sensor::PoseSensorHandler<
    msf_updates::pose_measurement::PoseMeasurement<>, PoseVelocityAltitudeSensorManager> PoseSensorHandler_T;
    friend class msf_pose_sensor::PoseSensorHandler<
            msf_updates::pose_measurement::PoseMeasurement<>, PoseVelocityAltitudeSensorManager>;
public:
    ...
    virtual ~PoseVelocityAltitudeSensorManager() {
    }
